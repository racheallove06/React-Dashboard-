...
export const EditorData = () => (
  <div>
    <h3>
      ...
      get started. Online Playgrounds If you are interested in playing around
      ...
      transformation, so we would only recommend using this for simple demos.
      Add React to a Website You can add React to an HTML page in one minute.
      You can then either gradually expand its presence, or keep it contained to
      a few dynamic widgets. Create a New React App When starting a React
      ...
      prefer a more theoretical or a practical approach, we hope you will find
      ...
      React examples with a live editor. Even if you do not know anything about
      ...
      faster pace than you are comfortable with, check out this overview of
      React by Tania Rascia. It introduces the most important React concepts in
      a detailed, beginner-friendly way. Once you are done, give the
      documentation another try! React for Designers If you are coming from a
      ...
      programming in the JavaScript language. You do not have to be an expert,
      but it is harder to learn both React and JavaScript at the same time. We
...
export const ordersData = [
  ...
  {
    OrderID: 345653,
    CustomerName: "Collins",
    TotalAmount: 100,
    OrderItems: "Fresh Apples",
    Location: "Nakuru",
    Status: "complete",
    StatusBg: "#5be7a9",
  ...
  {
    OrderID: 390457,
    CustomerName: "Frank Njoroge",
    TotalAmount: 300,
    OrderItems: "Fresh Lemons",
